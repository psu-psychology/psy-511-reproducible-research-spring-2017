...
- Consent, preparation procedures
    + Video useful? [[@gilmore-adolph-video-2017]](http://osf.io/3kvp7)
...
- Subject level descriptives and inferentials
    +	Aggregate to one row per subject per session
Primary hypotheses and major comparisons
