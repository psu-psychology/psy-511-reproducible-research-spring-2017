...
```
    ...
    ## -3.31200 -0.54460  0.15180  0.06753  0.76370  2.03500
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##  0.8044  1.5520  1.9640  1.9280  2.2610  3.2280
...
*Index by variable name:* X lies within the range of \[-3.312, 2.035\].

*Index by numeric index:* The (y-x) difference in means is `1.86047`.

*Calculate and report:* The correlation between x and y is 0.0663615.
